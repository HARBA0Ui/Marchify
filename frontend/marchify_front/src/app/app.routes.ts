...
import { BoutiqueCommentaireComponent } from './layouts/boutique-commentaire/boutique-commentaire.component';
...
export const routes: Routes = [
  ...
  // {
  //    path: 'boutique/:id/avis', 
  //    title:" Boutique ",
  //    component: BoutiqueCommentaireComponent 
  //   },
];
